          ...
          <div class="left">
            ...
            <div class="profilebox">
                  <div class="centerY">
                      ...
                      <h6 style="padding:5px">My Profile</h6>
            ...
            <div class="navigasi">
                <ul>
                  <li><a href="index.php">HOME</a><span class="icon"><i class="fa fa-dashboard"></i></span></li>
      ...
      <div style="width:calc(100% - 250px);float:left;">
        <div style="padding:5px 25px;">
          <div class="row">
            ...
            <div style="width:31.3%;position:relative;color:white;height:120px;backgroud:rgb(78, 133, 255);magin:20px 1%;flat:left;box-sizing:border-box;">
          ...
          <p style="font-size:8pt;opacity:0.3;margin:10px 0;">&copy; Risqi Destu Rahman - <?php echo Date('Y') ?> Copyright</p>
        </div>
      </div>
